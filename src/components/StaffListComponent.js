...
class StaffList extends Component {
  ...
  handleColumn(prop){
    switch (prop) {
      case 1:
        this.setState({ selectedColumnNumber: "col-md-12"})
        break;
      case 2:
        this.setState({ selectedColumnNumber: "col-md-5"})
        break;
      case 3:
        this.setState({ selectedColumnNumber: "col-md-3"})
        break;
      default:
        this.setState({ selectedColumnNumber: "col-lg-3 col-md-5"})
    }
  }
  renderStaff(staff) {
    if(staff!=null){
  ...
  render(){
    const menu = this.props.staffs.map((staff) => {
      return (
        <div id="item" className={ "col-12 "+this.state.selectedColumnNumber +" m-1"}>
  ...
  return (
    ...
    <ButtonGroup className="float-right d-none d-md-block">
